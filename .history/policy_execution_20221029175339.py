...
actoin_dim = (env.action_space.n,) if isinstance(env.action_space, gym.spaces.Discrete) else env.action_space.shape
...
def parse_args():
    ...
    parser.add_argument('--is_shared_network', type=bool, default=False)
...
if __name__ == "__main__":
    ...
    rollout_buffer = RolloutBuffer(buffer_size=args.rollout_steps,
                                ...
                                is_shared_network=args.is_shared_network)
